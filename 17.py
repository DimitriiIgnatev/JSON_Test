...
data = {'orderRef':143, 'marketDirection': 'buy', 'currency': 'EUR', 'amount': '143.00', 'counterCurrency': 'USD','beneficiaryAccountRef':'BA-MVBDZBL3Z', 'paymentPurpose': 'services', 'valueDate': '30/11/2018'}
...
#        allure.attach('response_headers', j.dumps(dict(response.headers), indent=4), type='json')
        ...
        allure.attach('response_json', str(response.json))
